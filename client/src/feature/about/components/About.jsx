...
{/* Hero Section */}
<section
  className="relative bg-cover bg-center h-[300px]" // further decreased height
        ...
        <div className="max-w-5xl mx-auto grid gap-12 md:grid-cols-3">
          <div className="bg-white shadow-lg rounded-xl p-8 border-t-4 border-blue-500 text-center">
            ...
            <p className="text-gray-700">
              To empower communities in Ethiopia by expanding access to quality healthcare, education, and community
              partnerships.
            </p>
          </div>
...
<div className="bg-white shadow-lg rounded-xl p-8 border-t-4 border-indigo-500 text-center flex flex-col items-center">
  ...
  <ol className="list-decimal text-left text-gray-700 space-y-2 max-w-xs">
    <li>Integrity</li>
    <li>Compassion</li>
    <li>Collaboration</li>
      ...
      <section className="bg-gray-50 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <p className="text-gray-700 text-lg leading-relaxed">
            HELP Ethiopia is registered in Ethiopia as a multidisciplinary non‑profit dedicated to supporting underserved
            communities. We partner with local and international stakeholders to address key development challenges,
            running programs in healthcare, education advocacy, and leadership development.
          </p>
          <p className="text-gray-700 text-lg leading-relaxed">
            Through strategic collaboration and community‑led initiatives, we bring sustainable solutions that
            expand opportunities and improve quality of life for all Ethiopians. 
            (<a href="https://et.linkedin.com/company/help-ethiopia" className="text-blue-600 hover:underline">LinkedIn</a>)
          </p>
        </div>
      </section>

      {/* Photo / Features Section */}
