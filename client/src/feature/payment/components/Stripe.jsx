...
import { CreditCard, Clock, Lock, ArrowRight } from "@phosphor-icons/react";

const Stripe = () => {
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg p-4 font-text">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        {/* Icon */}
        <div className="w-16 h-16 sm:w-20 sm:h-20 bg-linear-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-6">
          <CreditCard className="w-8 h-8 sm:w-10 sm:h-10 text-white" />
        </div>

        {/* Badge */}
        <div className="inline-flex items-center gap-1 sm:gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-full mb-6">
        ...
        {/* Title */}
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-darkblue mb-4">
          Stripe Integration Coming Soon
        </h2>

        {/* Description */}
        <p className="text-darkgray text-xs sm:text-sm md:text-base leading-6 md:leading-loose mb-4">
          We're currently working on integrating Stripe to provide you with a
          secure and seamless payment experience. This feature will be available
          shortly.
        </p>
        ...
        <div className="space-y-4">
          <Link
            to="/"
            className="block w-full py-3 sm:py-3.5 bg-linear-to-r from-blue-600  cursor-pointer to-blue-700 text-white rounded-xl text-xs sm:text-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02]"
          >
            Return to Homepage
          </Link>
          ...
          <button
            ...
            className="block w-full py-3 sm:py-3.5 bg-white text-gray-700 cursor-pointer text-xs sm:text-sm font-medium rounded-xl border border-gray-300 hover:border-blue-400 hover:bg-gray-50 transition-all duration-300"
          >
            Go Back
          </button>
        </div>
...
//                 >
//                   <MapPin className="text-gray-500 w-4 h-4 md:w-5 md:h-5 shrink-0" />
