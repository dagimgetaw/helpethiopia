...
const Register = () => {
  return (
    <div className="bg-bg font-text text-center py-4">
      <div className="max-w-5xl mx-auto px-6 md:px-16 lg:px-8">
        <div className="bg-white rounded-xl p-6 sm:p-8 md:p-12  shadow-md transition-shadow duration-300 border border-bg">
          ...
          <div className="inline-block">
            <Link to="/volunteer-registeration">
          ...
          <p className="mt-8 text-gray-700 leading-6 md:leading-loose text-center text-xs sm:text-sm md:text-base">
            Your support helps us continue our mission of transforming
